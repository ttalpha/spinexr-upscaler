...
import { DownloadFileItem } from '../main/download-file-item'
  ...
  if (historyFiles.length === 0)
    return (
      <div className="mt-6 flex flex-col items-center justify-center gap-y-4">
        <img src={noData} height="150px" width="150px" className="mx-auto" />
        <span className="text-sm font-medium text-gray-900">You currently have no files.</span>
      </div>
    )
  return (
